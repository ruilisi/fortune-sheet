          ...
          if (borderType === "border-left") {
            for (let bd_r = bd_r1; bd_r <= bd_r2; bd_r += 1) {
              ...
              if (bd_c_left >= 0 && borderInfoCompute[`${bd_r}_${bd_c_left}`]) {
                if (
                  !_.isNil(data[bd_r]) &&
                  _.isPlainObject(data[bd_r][bd_c_left]) &&
                  !_.isNil(data[bd_r][bd_c_left].mc)
                ) {
            ...
            for (let bd_c = bd_c1; bd_c <= bd_c2; bd_c += 1) {
              ...
              if (bd_r_top >= 0 && borderInfoCompute[`${bd_r_top}_${bd_c}`]) {
                if (
                  !_.isNil(data[bd_r_top]) &&
                  _.isPlainObject(data[bd_r_top][bd_c]) &&
                  !_.isNil(data[bd_r_top][bd_c].mc)
                ) {
            ...
            for (let bd_c = bd_c1; bd_c <= bd_c2; bd_c += 1) {
              ...
              if (
                ...
                if (
                  !_.isNil(data[bd_r_bottom]) &&
                  _.isPlainObject(data[bd_r_bottom][bd_c]) &&
                  !_.isNil(data[bd_r_bottom][bd_c].mc)
                ) {
            ...
            for (let bd_r = bd_r1; bd_r <= bd_r2; bd_r += 1) {
              ...
              for (let bd_c = bd_c1; bd_c <= bd_c2; bd_c += 1) {
                if (
                  !_.isNil(data[bd_r]) &&
                  _.isPlainObject(data[bd_r][bd_c]) &&
                  !_.isNil(data[bd_r][bd_c].mc)
                ) {
